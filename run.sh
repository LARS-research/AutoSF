...
python train.py --task_dir=../../KG_Data/WN18RR --optim=adagrad --lamb=0. --lr=0.7 --n_epoch=200 --n_dim=64 --n_batch=512 --epoch_per_test=40 --test_batch_size=50 --thres=0.0 --decay_rate=0.9915589 --parrel=1;
